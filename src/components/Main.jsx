    ...
    <View style={{ flex: 1, paddingTop: insets.top, paddingBottom: insets.bottom }}>
      <View style={styles.container}>
        <TouchableHighlight
          ...
          style={{ backgroundColor: 'red', width: 200, height: 200, justifyContent: 'center', alignItems: 'center' }}
        >
          <Text style={{ color: 'white' }}>Ver jugadores</Text>
        </TouchableHighlight>

        <Text style={{ marginTop: 20, backgroundColor: 'blue', color: 'white' }}>huhukhuj</Text>
      </View>
    </View>
  );
}
