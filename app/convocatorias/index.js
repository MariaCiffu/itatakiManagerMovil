// app/convocatorias/index.js
import React, { useState, useEffect } from 'react';
import { View, Text, StyleSheet, ScrollView, TouchableOpacity, TextInput, Switch, Alert, Linking, Platform, Modal, FlatList } from 'react-native';
...
const PLANTILLAS = [
  {
    ...
    texto: '🔵🔴 *CONVOCATORIA FC BARCELONA* 🔵🔴\n\n📅 Fecha: {fecha}\n⏰ Hora: {hora}\n📍 Lugar: {lugar}\n🆚 Rival: {rival}\n\n*Jugadores convocados:*\n{jugadores}\n\nSe ruega puntualidad. Traer DNI y equipación completa.',
  },
  {
    id: 'entrenamiento',
    nombre: 'Aviso entrenamiento',
    texto: '🔵🔴 *ENTRENAMIENTO FC BARCELONA* 🔵🔴\n\n📅 Fecha: {fecha}\n⏰ Hora: {hora}\n📍 Lugar: {lugar}\n\n*Jugadores convocados:*\n{jugadores}\n\nSe ruega puntualidad. Traer equipación de entrenamiento.',
  },
  {
    id: 'multas',
    nombre: 'Informe de multas',
    texto: '🔵🔴 *INFORME DE MULTAS PENDIENTES* 🔵🔴\n\n📅 Fecha: {fecha}\n\n*Jugadores con multas pendientes:*\n{jugadores}\n\nSe ruega realizar el pago lo antes posible.',
  },
];
...
export default function Convocatorias() {
  ...
  const searchPlaces = (query) => {
    ...
    const mockResults = [
      { id: '1', name: 'Estadio Camp Nou', address: 'C. d\'Arístides Maillol, 12, 08028 Barcelona', coords: { lat: 41.3809, lng: 2.1228 } },
      { id: '2', name: 'Ciudad Deportiva Joan Gamper', address: 'Av. Onze de Setembre, s/n, 08970 Sant Joan Despí, Barcelona', coords: { lat: 41.3773, lng: 2.0502 } },
      { id: '3', name: 'Estadio Olímpico Lluís Companys', address: 'Passeig Olímpic, 17-19, 08038 Barcelona', coords: { lat: 41.3650, lng: 2.1544 } },
    ];
  ...
  const generarMensaje = () => {
    ...
    // Si hay una ubicación seleccionada con coordenadas, añadir el enlace de Maps
  ...
  const enviarPorWhatsApp = async () => {
    ...
    if (!datos.fecha || !datos.hora || !datos.lugar || 
        ...
        (plantillaSeleccionada.id !== 'multas' && Object.keys(jugadoresSeleccionados).filter(id => jugadoresSeleccionados[id]).length === 0)) {
  ...
  const enviarPorWhatsAppIndividual = async () => {
    ...
    Alert.alert(
      'Enviar mensaje',
      '¿Quieres enviar este mensaje a todos los jugadores seleccionados individualmente?',
      [
        {
          text: 'Cancelar',
          style: 'cancel'
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.actionButtons}>
            ...
            <TouchableOpacity 
              style={styles.actionButton}
              onPress={enviarPorWhatsAppIndividual}
              activeOpacity={0.8}
            >
              <LinearGradient
